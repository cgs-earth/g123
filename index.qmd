...
sf::write_sf(sf,"data/superfund_geocode.gpkg")
write_csv(sf %>% st_drop_geometry(),"data/superfund_geocode.csv")
...
sf::write_sf(sf,"data/landfill_geocode.gpkg")
write_csv(sf %>% st_drop_geometry(),"data/landfill_geocode.csv")
